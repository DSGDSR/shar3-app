    ...
    return (
        <div className="fixed z-50 w-72 max-w-[90%] h-16 -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
            <div className="grid h-full max-w-lg grid-cols-3 mx-auto">
                <NavItem key={'nav-theme'} title="Theme" icon={<SunIcon/>} className="rounded-l-full"/>
                ...
                <NavItem key={'nav-settings'} id="settings" title="Settings" icon={<SettingsIcon/>} className="rounded-r-full"/>
            </div>
        </div>
    );
}
